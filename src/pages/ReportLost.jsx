...
function ReportLost() {
  ...
  return (
    <div className="report-page">
      <div className="report-form-card lost-report-card">
        ...
        {!submitted ? (
          <>
            <div className="report-header">
              ...
              <p>
                Tell us about the item you lost and
                we'll help others find it.
              </p>
            ...
            >
              ...
              <button
                className="submit-report-btn lost-submit-btn"
                type="submit"
                disabled={loading}
              >
                {loading
          ...
          <div className="success-message">
            ...
            <p>
              ...
              successfully. Other students can
              now help you find it.
            </p>
